...
-- local wimg = {}
-- wimg.Save = function(url,name)
-- 	if (!name) then return end
-- 	http.Fetch(url,function(data)
-- 		file.CreateDir('kchk_img_data')
-- 		file.Write('kchk_img_data/'.. name ..".png", data)
-- 	end)
-- end 
-- wimg.Get = function(url,name)
-- 	local mat = Material('data/kchk_img_data/'.. name ..".png")
-- end 

hook.Call("GMIsLoaded", GAMEMODE)