...
local pp_mat_overlay2 = CreateClientConVar( "pp_mat_overlay22", "", false, false )
local pp_mat_overlay_refractamount = CreateClientConVar( "pp_mat_overlay_refractamount", "0.3", true, false )
...
hook.Add( "RenderScreenspaceEffects", "RenderMaterialOverlay", function()
	...
	local overlay = pp_mat_overlay2:GetString()
...
local pp_mat_overlay3 = CreateClientConVar( "pp_mat_overlay2", "", false, false )
local pp_mat_overlay_refractamount = CreateClientConVar( "pp_mat_overlay_refractamount", "0.3", true, false )
...
hook.Add( "RenderScreenspaceEffects", "RenderMaterialOverlay", function()
	...
	local overlay = pp_mat_overlay3:GetString()
